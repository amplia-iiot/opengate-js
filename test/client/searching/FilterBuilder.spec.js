define(function () {
    ...
    describe('Check funcionality FilterBuilder module:', function () {
        ...
        it('Creating like inside the and', function () {
            assert.strictEqual(
                JSON.stringify(ogapi.newFilterBuilder().and(ogapi.EX.like('hello', 'world'))._filterTemplate),
                '{"filter":{"and":[{"like":{"hello":"world"}}]}}'
            );
        });
        /** @test {FilterBuilder#and} */
        it('Creating two operators inside the and', function () {
            ...
            assert.strictEqual(
                JSON.stringify(
                    ogapi.newFilterBuilder().and(ogapi.EX.like('hello', 'world'), ogapi.EX.neq('hello', 'world'))._filterTemplate
                ),
                resul
            );
        });
