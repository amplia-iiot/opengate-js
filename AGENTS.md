...
- Keep folder names lower-case domain terms. Keep public builders and entry points documented: the published documentation *is* the JSDoc, so a wording fix belongs in `src/`.
