 ...
 */
export const CONNECTOR_FUNCTION_OPERATIONAL_STATUS = ['DISABLED', 'PRODUCTION', 'TEST'];
 ...
 */
export const CONNECTOR_FUNCTION_SOUTH_PROTOCOLS = ['https://', 'wss://', 'mqtts://', 'snmps://', 'dlms://', 'icmp:///', 'coaps://'];
