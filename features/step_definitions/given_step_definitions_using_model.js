...
module.exports = function () {
    ...
    this.Given(/^an ogapi "([^"]*)" util with "([^"]*)" and "([^"]*)"$/, function (utilName, param1, param2, callback) {
    ...
    this.Given(/^I read the file from "([^"]*)" for provision tickets$/, function (fileName, callback) {
        // Write code here that turns the phrase above into concrete actions
        var _this = this;
