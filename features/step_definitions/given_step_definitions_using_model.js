...
Given(
    /^I want to (create|find|read|delete|update|search) (a|an) "([^"]*)" and the start limit by "([^"]*)" and size limit by "([^"]*)"$/,
    function (model, dummyWildcard, entity, start, size, callback) {
        this.currentModel = model;
        this.currentEntity = entity;
        this.limit = {
            size: size,
...
Given(
    /^I create (a|an) "([^"]*)" from current "([^"]*)" using previous file and params:$/,
    function (dummyWc1, setterName, currentEntity, table) {
        var _this = this;
        _this.error = undefined;
        _this.responseData = undefined;
...
Given(
    /^I (create|delete) (a|an) "([^"]*)" from current "([^"]*)" using params:$/,
    function (selectedAction, dummyWc1, setterName, currentEntity, table) {
        var _this = this;
        _this.error = undefined;
        _this.responseData = undefined;
