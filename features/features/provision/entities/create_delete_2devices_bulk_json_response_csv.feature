...
Feature: Delete and Create a Device - 2 devices bulk response csv
  ...
  Scenario: I want to create a device from json file
    ...
    Then the content of file "result.csv" must match:
      """
      statusCode;location;errors\n201;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_1;\n201;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_2;\n
      """
  ...
  Scenario: I want to create a device from json file - duplicated error
    ...
    Then the content of file "result.csv" must match:
      """
      statusCode;location;errors\n400;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_1;\[\{"code":"0x010114","message":"Entity duplicated\.","context":\[\]}]\n400;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_2;\[\{"code":"0x010114","message":"Entity duplicated\.","context":\[\]},{"code":"0x010114","message":"Entity duplicated\.","context":\[\]},{"code":"0x010114","message":"Entity duplicated\.","context":\[\]},{"code":"0x010114","message":"Entity duplicated\.","context":\[\]}]\n
      """
  ...
  Scenario: I want to delete a device from json file
    ...
    Then the content of file "result.csv" must match:
      """
      statusCode;location;errors\n200;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_1;\n200;https:\/\/([\d\d\d]{1,3}\.){3}[\d\d\d]{1,3}:[\d\d\d]{1,4}\/v80\/provision\/organizations\/organization_bulk_10\/devices\/device_bulk_json_2;\n
      """
