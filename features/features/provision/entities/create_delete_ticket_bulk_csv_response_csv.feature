# features/provision/entities/create_delete_ticket_bulk_csv_response_csv.feature
@provision
@create_provision
@entities_provision
@tickets_provision
@bulk_ticket_csv_response_csv
...
Feature: Delete and Create a ticket
  ...
  Scenario: I want to create a ticket from csv file
