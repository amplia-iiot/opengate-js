# features/provision/entities/create_delete_ticket_bulk_json_flattened.feature
@provision
@create_provision
@tickets_provision
@bulk_ticket_json_flattened
@bulk_json_flattened
@bulk
@bulk_ticket
@OUW-1750
...
Feature: Delete and Create a ticket
  ...
  Scenario: I want to create a ticket from json file
    Given an ogapi "json flattened bulk builder" util with "organization_bulk_10" and "tickets"
  ...
  Scenario: I want to delete a ticket from json file
    Given an ogapi "json flattened bulk builder" util with "organization_bulk_10" and "tickets"
    And I read the file from "/file_test/bulk_double_flattened_tickets.json"
