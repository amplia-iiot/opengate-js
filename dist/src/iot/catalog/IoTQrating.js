...
var IoTQrating = (function () {
    function IoTQrating() {
        _classCallCheck(this, IoTQrating);
    }
    ...
    _createClass(IoTQrating, [{
        ...
        value: function _isValidString(string, param_name, max_length) {
            if (typeof string !== 'string' || string.length === 0 || string.length > max_length) throw new Error('Parameter ' + param_name + ' must be a string, cannot be empty and has a maximum length of ' + max_length + ' on IoTQrating');
        }
    }, {
        key: '_isValidNumber',
        value: function _isValidNumber(number, param_name) {
            if (typeof number !== 'number') throw new Error('Parameter ' + param_name + ' must be a number, cannot be empty on IoTQrating');
        }
    }]);
...
exports['default'] = IoTQrating;
module.exports = exports['default'];
//# sourceMappingURL=IoTQrating.js.map
