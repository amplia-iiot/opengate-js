...
var Geocluster = (function (_BaseProvision) {
    _inherits(Geocluster, _BaseProvision);
    ...
    _createClass(Geocluster, [{
        ...
        value: function _buildURL() {
            var url = 'provision/geocluster/' + this._identifier + '/clustering';
            return url;
        }
        ...
        value: function _composeElementUpdate() {
            var geocluster = _get(Object.getPrototypeOf(Geocluster.prototype), '_composeUpdateElement', this).call(this);
            return geocluster;
        }
    }, {
        key: 'update',
...
//# sourceMappingURL=Geocluster.js.map
