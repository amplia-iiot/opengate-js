...
var DevicePlansFinder = (function (_ProvisionGenericFinder) {
    _inherits(DevicePlansFinder, _ProvisionGenericFinder);

    /**     
     * @param {InternalOpenGateAPI} Reference to the API object.
     */

    function DevicePlansFinder(ogapi) {
        _classCallCheck(this, DevicePlansFinder);

        _get(Object.getPrototypeOf(DevicePlansFinder.prototype), 'constructor', this).call(this, ogapi, 'organizations', undefined, 'Organization plan not found');
    }
    ...
    _createClass(DevicePlansFinder, [{
        key: '_composeUrl',
        value: function _composeUrl() {
            var _url = this._baseUrl + "/" + this._organization + "/" + _URL_ENUM.DEVICE_PLANS;
        ...
        value: function findByOrganization(organization) {
            ...
            this._entity = _URL_ENUM.DEVICE_PLANS;
    ...
    return DevicePlansFinder;
})(_ProvisionGenericFinder3['default']);

exports['default'] = DevicePlansFinder;
module.exports = exports['default'];
//# sourceMappingURL=DevicePlansFinder.js.map
