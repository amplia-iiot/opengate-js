...
var ConnectorFunctions = (function (_BaseProvision) {
    ...
    _createClass(ConnectorFunctions, [{
        ...
        value: function withNorthCriterias(northCriterias) {
            if (!(northCriterias instanceof Array)) throw (0, _utilParameterError2['default'])('Parameter northCriterias requires an array', { parameter: 'northCriterias' });
        ...
        value: function addNorthCriteria(northCriteria) {
            if (typeof northCriteria !== 'object' || !northCriteria.path || typeof northCriteria.path !== 'string' || !northCriteria.value || typeof northCriteria.value !== 'object') throw (0, _utilParameterError2['default'])('Parameter northCriteria requires path and value', { parameter: 'northCriteria' });
        ...
        value: function withSouthCriterias(southCriterias) {
            ...
            if (!(southCriterias instanceof Array)) throw (0, _utilParameterError2['default'])('Parameter southCriterias requires an array', { parameter: 'southCriterias' });
        ...
        value: function _checkRequiredParameters(isUpdate) {
            if (isUpdate && this._identifier === undefined) {
                throw (0, _utilParameterError2['default'])('Parameter identifier must be defined', { parameter: 'identifier' });
            }
