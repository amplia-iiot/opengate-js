...
var OperationsSearchBuilder = (function (_SearchWithSummaryBuilder) {
  _inherits(OperationsSearchBuilder, _SearchWithSummaryBuilder);

  /**
   *  @param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
   */

  function OperationsSearchBuilder(parent) {
    _classCallCheck(this, OperationsSearchBuilder);

    _get(Object.getPrototypeOf(OperationsSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
    this._url = BASE_URL;
  }
...
exports['default'] = OperationsSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=OperationsSearchBuilder.js.map
