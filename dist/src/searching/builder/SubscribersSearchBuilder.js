...
var BASE_URL = '/subscribers';
/**
 * Defined a search over Subscribers	
 * @example ogapi.subscribersSearchBuilder()
 */

var SubscribersSearchBuilder = (function (_EntitySearchBuilder) {
  _inherits(SubscribersSearchBuilder, _EntitySearchBuilder);
  ...
  function SubscribersSearchBuilder(parent) {
    ...
    _get(Object.getPrototypeOf(SubscribersSearchBuilder.prototype), 'constructor', this).call(this, parent, BASE_URL, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
  }
