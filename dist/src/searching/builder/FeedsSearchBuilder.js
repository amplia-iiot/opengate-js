...
var FeedsSearchBuilder = (function (_SearchBuilder) {
    _inherits(FeedsSearchBuilder, _SearchBuilder);

    /**
     *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
     */

    function FeedsSearchBuilder(parent) {
        _classCallCheck(this, FeedsSearchBuilder);

        _get(Object.getPrototypeOf(FeedsSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
        this._url = BASE_URL;
    }
    ...
    _createClass(FeedsSearchBuilder, [{
        key: 'build',
...
exports['default'] = FeedsSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=FeedsSearchBuilder.js.map
