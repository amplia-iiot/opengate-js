...
var SubscriptionsSearchBuilder = (function (_FlattenedSearchBuilder) {
    ...
    function SubscriptionsSearchBuilder(parent) {
        ...
        _get(Object.getPrototypeOf(SubscriptionsSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, '/subscriptions'));
        this._url = BASE_URL;
    }

    _createClass(SubscriptionsSearchBuilder, [{
        key: '_buildFilter',
