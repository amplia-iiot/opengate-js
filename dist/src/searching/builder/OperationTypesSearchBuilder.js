...
var _SearchWithoutLimit = require('../SearchWithoutLimit');

var _SearchWithoutLimit2 = _interopRequireDefault(_SearchWithoutLimit);
...
var OperationTypesBuilder = (function (_SearchBuilder) {
    _inherits(OperationTypesBuilder, _SearchBuilder);

    /**
     *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
     */

    function OperationTypesBuilder(parent) {
        _classCallCheck(this, OperationTypesBuilder);

        _get(Object.getPrototypeOf(OperationTypesBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
        this._url = BASE_URL;
    }
    ...
    return OperationTypesBuilder;
})(_SearchBuilder3['default']);

exports['default'] = OperationTypesBuilder;
module.exports = exports['default'];
//# sourceMappingURL=OperationTypesSearchBuilder.js.map
