...
var AssetsSearchBuilder = (function (_PreFilteredSearchBuilder) {
    _inherits(AssetsSearchBuilder, _PreFilteredSearchBuilder);
    ...
    _createClass(AssetsSearchBuilder, [{
        ...
        value: function build() {
            return new _AssetSearch2['default'](this._parent, this._buildUrl(), this._buildFilter(), this._buildLimit(), this._buildSort(), this._buildGroup(), this._buildSelect(), this._builderParams.timeout, this._urlParams);
        }
...
exports['default'] = AssetsSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=AssetsSearchBuilder.js.map
