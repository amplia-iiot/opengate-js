...
var BulkSearchBuilder = (function (_SearchBuilder) {
  _inherits(BulkSearchBuilder, _SearchBuilder);

  /**
   *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
   */

  function BulkSearchBuilder(parent) {
    _classCallCheck(this, BulkSearchBuilder);

    _get(Object.getPrototypeOf(BulkSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
    this._url = BASE_URL;
  }
...
exports['default'] = BulkSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=BulkSearchBuilder.js.map
