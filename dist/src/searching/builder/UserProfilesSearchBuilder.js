...
var UserProfilesSearchBuilder = (function (_SearchBuilder) {
    _inherits(UserProfilesSearchBuilder, _SearchBuilder);

    /**
     *  @param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
     */

    function UserProfilesSearchBuilder(parent) {
        _classCallCheck(this, UserProfilesSearchBuilder);

        _get(Object.getPrototypeOf(UserProfilesSearchBuilder.prototype), 'constructor', this).call(this, parent, {});
    ...
    _createClass(UserProfilesSearchBuilder, [{
        ...
        value: function build() {
            return new _StaticSearch2['default'](this._parent, this._buildUrl(), this._buildFilter(), this._builderParams.timeout, 'userProfile', this.customFilters);
        }
        ...
        key: 'withId',
        value: function withId(userProfileId) {
...
exports['default'] = UserProfilesSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=UserProfilesSearchBuilder.js.map
