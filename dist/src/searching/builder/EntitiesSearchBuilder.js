...
var EntitiesSearchBuilder = (function (_SearchWithSummaryBuilder) {
    _inherits(EntitiesSearchBuilder, _SearchWithSummaryBuilder);

    /**
     *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
     */

    function EntitiesSearchBuilder(parent) {
        var fieldFinder = arguments.length <= 1 || arguments[1] === undefined ? new _utilSearchingFieldsFieldFinder2['default'](parent, '/entities') : arguments[1];
        return (function () {
            _classCallCheck(this, EntitiesSearchBuilder);

            _get(Object.getPrototypeOf(EntitiesSearchBuilder.prototype), 'constructor', this).call(this, parent, {
                onDevices: '/devices'
            }, fieldFinder);
...
exports['default'] = EntitiesSearchBuilder;
//# sourceMappingURL=EntitiesSearchBuilder.js.map
