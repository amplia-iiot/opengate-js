...
var WorkgroupsSearchBuilder = (function (_SearchWithSummaryBuilder) {
  _inherits(WorkgroupsSearchBuilder, _SearchWithSummaryBuilder);

  /**
   *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
   */

  function WorkgroupsSearchBuilder(parent) {
    _classCallCheck(this, WorkgroupsSearchBuilder);

    _get(Object.getPrototypeOf(WorkgroupsSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
    this._url = BASE_URL;
  }
...
exports['default'] = WorkgroupsSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=WorkgroupsSearchBuilder.js.map
