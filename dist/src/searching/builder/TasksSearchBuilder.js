...
var TasksSearchBuilder = (function (_SearchWithSummaryBuilder) {
  _inherits(TasksSearchBuilder, _SearchWithSummaryBuilder);

  /**
   *  @param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
   */

  function TasksSearchBuilder(parent) {
    _classCallCheck(this, TasksSearchBuilder);

    _get(Object.getPrototypeOf(TasksSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
    this._url = BASE_URL;
  }
...
exports['default'] = TasksSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=TasksSearchBuilder.js.map
