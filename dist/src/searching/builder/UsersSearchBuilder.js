...
var UsersSearchBuilder = (function (_SearchWithSummaryBuilder) {
  _inherits(UsersSearchBuilder, _SearchWithSummaryBuilder);

  /**
   *	@param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
   */

  function UsersSearchBuilder(parent) {
    _classCallCheck(this, UsersSearchBuilder);

    _get(Object.getPrototypeOf(UsersSearchBuilder.prototype), 'constructor', this).call(this, parent, {}, new _utilSearchingFieldsFieldFinder2['default'](parent, BASE_URL));
    this._url = BASE_URL;
  }
...
exports['default'] = UsersSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=UsersSearchBuilder.js.map
