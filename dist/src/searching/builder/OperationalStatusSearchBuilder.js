...
var OperationalStatusSearchBuilder = (function (_SearchBuilder) {
    _inherits(OperationalStatusSearchBuilder, _SearchBuilder);

    /**
     *  @param {!InternalOpenGateAPI} parent - Instance of our InternalOpenGateAPI
     */

    function OperationalStatusSearchBuilder(parent) {
        _classCallCheck(this, OperationalStatusSearchBuilder);

        _get(Object.getPrototypeOf(OperationalStatusSearchBuilder.prototype), 'constructor', this).call(this, parent, {});
    ...
    _createClass(OperationalStatusSearchBuilder, [{
        ...
        value: function build() {
            return new _StaticSearch2['default'](this._parent, this._buildUrl(), this._buildFilter(), this._builderParams.timeout, 'operationalStatus', this.customFilters);
        }
        ...
        key: 'withId',
        value: function withId(operationalStatusId) {
...
exports['default'] = OperationalStatusSearchBuilder;
module.exports = exports['default'];
//# sourceMappingURL=OperationalStatusSearchBuilder.js.map
