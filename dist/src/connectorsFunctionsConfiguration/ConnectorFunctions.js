...
var ConnectorFunctions = (function (_BaseProvision) {
    ...
    _createClass(ConnectorFunctions, [{
        ...
        value: function withOperationalStatus(operationalStatus) {
            if (typeof operationalStatus !== 'string' || !this._checkValues(operationalStatus, _enum_CONNECTOR_FUNCTIONS_ENUMS.CONNECTOR_FUNCTION_OPERATIONAL_STATUS)) throw new Error('Parameter operational status must be a string and must be one of these values: ' + _enum_CONNECTOR_FUNCTIONS_ENUMS.CONNECTOR_FUNCTION_OPERATIONAL_STATUS);
