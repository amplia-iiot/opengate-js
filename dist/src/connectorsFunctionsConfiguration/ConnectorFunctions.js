...
var ConnectorFunctions = (function (_BaseProvision) {
    ...
    _createClass(ConnectorFunctions, [{
        ...
        value: function withNorthCriterias(criterias) {
            if (typeof criterias !== 'array' || criterias.length === 0) throw new Error('Parameter north criteria must be an array and cannot be empty');
        ...
        value: function withSouthCriterias(criterias) {
            ...
            if (typeof criterias !== 'array' || criterias.length === 0) throw new Error('Parameter south criteria must be an array and cannot be empty');
        ...
        value: function withType(type) {
            if (typeof type !== 'string' || !this._checkValues(type, _enum_CONNECTOR_FUNCTIONS_ENUMS.CONNECTOR_FUNCTION_TYPES)) throw new Error('Parameter type must be a string and must be one of these values: ' + _enum_CONNECTOR_FUNCTIONS_ENUMS.CONNECTOR_FUNCTION_TYPES);
        ...
        value: function _checkRequiredParameters(isUpdate) {
            if (isUpdate) {
                if (this._identifier === undefined || this._organization === undefined || this._channel === undefined || this._active === undefined || this._type === undefined || this._javascript === undefined) throw new Error('Parameters organization, channel, active, type, javascript and identifier must be defined');
            } else {
                if (this._name === undefined || this._organization === undefined || this._channel === undefined || this._active === undefined || this._type === undefined || this._javascript === undefined) throw new Error('Parameters organization, channel, active, type, javascript and name must be defined');
            }
        }
    }, {
        key: '_buildURL',
