 ...
 */
	...
	function ByMonth(parent, date, periodicityName, months, end) {
		_classCallCheck(this, ByMonth);

		_get(Object.getPrototypeOf(ByMonth.prototype), "constructor", this).call(this, parent, date, periodicityName, end);
		this._months = months;
