...
var _AlarmOperationBuilder2 = require('./AlarmOperationBuilder');

var _AlarmOperationBuilder3 = _interopRequireDefault(_AlarmOperationBuilder2);

/**
* Defines the builder to execute alarm attend operation
*/

var AlarmAttendBuilder = (function (_AlarmOperationBuilder) {
	_inherits(AlarmAttendBuilder, _AlarmOperationBuilder);
...
})(_AlarmOperationBuilder3['default']);
