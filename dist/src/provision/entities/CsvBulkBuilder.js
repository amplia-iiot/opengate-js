...
var CsvBulkBuilder = (function (_BulkBuilder) {
    ...
    function CsvBulkBuilder(ogapi, organization, resource, timeout, async) {
        _classCallCheck(this, CsvBulkBuilder);

        _get(Object.getPrototypeOf(CsvBulkBuilder.prototype), 'constructor', this).call(this, ogapi, 'provision/organizations/' + organization + '/bulk/' + (async ? 'async' : resource.toLowerCase()), 'text/plain', timeout);
