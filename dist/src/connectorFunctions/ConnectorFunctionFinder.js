...
var ConnectorFunctionFinder = (function (_GenericFinder) {
  _inherits(ConnectorFunctionFinder, _GenericFinder);

  /**     
   * @param {InternalOpenGateAPI} ogapi - Reference to the API object.
   */

  function ConnectorFunctionFinder(ogapi) {
    _classCallCheck(this, ConnectorFunctionFinder);

    _get(Object.getPrototypeOf(ConnectorFunctionFinder.prototype), 'constructor', this).call(this, ogapi, 'connectorFunctions');
  }
...
exports['default'] = ConnectorFunctionFinder;
module.exports = exports['default'];
//# sourceMappingURL=ConnectorFunctionFinder.js.map
