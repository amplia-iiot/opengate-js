...
```javascript
var builder = ogapi.devicesSearchBuilder().onProvisioned();
var search;
try {
...
```javascript
var builder = ogapi.executionsSearchBuilder().onCommunicationsModules();
var search;
try {
    search = builder.build();
} catch (builderError) {
...
```javascript
var builder = ogapi.datastreamsSearchBuilder();
```

or

```javascript
var builder = ogapi.profilesSearchBuilder();
```
...
```javascript
var builder = ogapi.datapointsSearchBuilder();
```
